    ...
    <div class="lq-news-grid">
      <div class="lq-news-group">
        ...
        <div class="lq-news-cards">
          <!-- Noticias más recientes irán aquí -->
        </div>
      </div>
      <div class="lq-news-group">
        <div class="lq-news-group-head"><h3 class="lq-news-group-title">Actualizaciones de LICUADO</h3></div>
        <div class="lq-news-cards">
          <!-- Noticias de LICUADO irán aquí -->
        </div>
      </div>
      <div class="lq-news-group">
        <div class="lq-news-group-head"><h3 class="lq-news-group-title">Actualizaciones de Kronos</h3></div>
        <div class="lq-news-cards">
          <!-- Noticias de Kronos irán aquí -->
        </div>
      </div>
      <div class="lq-news-group">
        <div class="lq-news-group-head"><h3 class="lq-news-group-title">Actualizaciones de Teia</h3></div>
        <div class="lq-news-cards">
          <!-- Noticias de Teia irán aquí -->
        </div>
      </div>
      <div class="lq-news-group">
        <div class="lq-news-group-head"><h3 class="lq-news-group-title">Notícias de Creatorius</h3></div>
        <div class="lq-news-cards">
          <!-- Noticias de Creatorius irán aquí -->
        </div>
      </div>
      <div class="lq-news-group">
        <div class="lq-news-group-head"><h3 class="lq-news-group-title">Otras notícias</h3></div>
        <div class="lq-news-cards">
          <!-- Otras noticias irán aquí -->
        </div>
      </div>
      <div class="lq-news-group">
        <div class="lq-news-group-head"><h3 class="lq-news-group-title">Todas las notícias</h3></div>
        <div class="lq-news-cards">
          <!-- Todas las noticias irán aquí -->
        </div>
      </div>
    </div>
  </section>
...
Este es un tema delicado, y quien me crea, es libre de hacerlo o de no hacerlo, solo tú decides si es real. No dejes que nadie te imponga sus creéncias. Yo solo lo comunico, pero nadie está seguro de la verdad sobre nuestro origen o sobre lo que somos, y me incluyo. O al menos en mi caso desconozco la verdad sobre los secretos políticos del vaticano y el área 51 y muchos más. A veces ni siquiera estoy seguro de si estoy vivo o de si soy un jugador, siguiendo esa misma rutina diária todos los días de mi vida en el interminable e inutil instituto.</p>
  ...
  <div class="lq-modal-overlay" id="lq-verdad-panel">
    <div class="lq-modal lq-dios-modal">
      ...
      <button class="lq-dios-arrow lq-dios-arrow-left" type="button" data-lq-verdad-dir="-1" aria-label="Anterior">&#8592;</button>
      <button class="lq-dios-arrow lq-dios-arrow-right" type="button" data-lq-verdad-dir="1" aria-label="Siguiente">&#8594;</button>
      <div class="lq-dios-viewport">
